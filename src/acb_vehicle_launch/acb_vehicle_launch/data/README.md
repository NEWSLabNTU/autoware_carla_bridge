...
2. Configure paths in `config/raw_vehicle_cmd_converter/raw_vehicle_cmd_converter.param.yaml`:
   ```yaml
   csv_path_accel_map: $(find-pkg-share acb_vehicle_launch)/data/accel_map.csv
   csv_path_brake_map: $(find-pkg-share acb_vehicle_launch)/data/brake_map.csv
   csv_path_steer_map: $(find-pkg-share acb_vehicle_launch)/data/steer_map.csv
